...
def Scraper(HashTable, TimeTable, BtcTable, UsdTable, connect, DataInBase):
    ...
    blockchain = get('https://www.blockchain.com/btc/unconfirmed-transactions')
